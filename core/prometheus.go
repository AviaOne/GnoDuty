...
func prometheusExporter(ctx context.Context, updates chan *promUpdate) {
	...
	signed := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_signed_blocks",
		Help: "count of blocks signed since gnoduty was started",
	}, chainLabels)
	proposed := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_proposed_blocks",
		Help: "count of blocks proposed since gnoduty was started",
	}, chainLabels)
	missed := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_missed_blocks",
		Help: "count of blocks missed without seeing a precommit or prevote since gnoduty was started",
	}, chainLabels)
	missedPrevote := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_missed_blocks_prevote_present",
		Help: "count of blocks missed where a prevote was seen since gnoduty was started",
	}, chainLabels)
	missedPrecommit := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_missed_blocks_precommit_present",
		Help: "count of blocks missed where a precommit was seen since gnoduty was started",
	}, chainLabels)
	missedConsecutive := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_consecutive_missed_blocks",
	...
	lastBlockSec := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_time_since_last_block",
	...
	lastBlockSecUnfinalized := promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "gnoduty_time_since_last_block_unfinalized",
